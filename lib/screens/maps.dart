...
import 'package:hackatec/services/maps_service.dart';
                ...
                children: <Widget>[
                  ...
                  Positioned(
                    ...
                    child: Container(
                      width: 60,
                      height: 60,
                      decoration: BoxDecoration(color: ORANGE_MAIN),
                      child: MaterialButton(
                        onPressed: () {
                          if (widget.value?.latitude == null ||
                              widget.value?.longitude == null) {
                            context.read<MapProvider>().setCoords(
                                widget.initCoordinates.latitude,
                                widget.initCoordinates.longitude);
                            print(widget.initCoordinates);
                          } else {
                            print(widget.value?.latitude.toString());
                            context.read<MapProvider>().setCoords(
